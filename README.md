...
iverilog -o sim_naive tb/tb_gf128_naive.v rtl/gf128_naive.v
vvp sim_naive

iverilog -o sim_compare tb/tb_gf128_compare.v rtl/gf128_naive.v rtl/gf128_karatsuba.v rtl/gf64_mul.v
vvp sim_compare

iverilog -o sim_kara_vs_naive tb/tb_gf128_naive_vs_kara_reduced.v \
    rtl/gf128_naive_reduced.v rtl/gf128_naive.v rtl/gf128_reduce_opt.v \
    rtl/gf128_mul_reduced.v rtl/gf128_karatsuba.v rtl/gf64_mul.v
vvp sim_kara_vs_naive
```

**Pipelined architecture (Arch 3):**
```bash
iverilog -o sim_pipe tb/tb_gf64_pipe2.v rtl/gf64_mul_pipe2.v
vvp sim_pipe
```
